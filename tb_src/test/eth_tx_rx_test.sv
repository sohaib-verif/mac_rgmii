...
class eth_tx_rx_test extends uvm_test;
  `uvm_component_utils(eth_tx_rx_test)
  ...
  function new(string name = "eth_tx_rx_test", uvm_component parent);
  ...
  function void build_phase(uvm_phase phase);
    ...
    `uvm_info(get_type_name(), "eth_tx_rx_test build phase started", UVM_LOW)
