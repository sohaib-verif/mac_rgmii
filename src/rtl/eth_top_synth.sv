...
//=============================================================================
// ETHERNET TOP SYNTHESIS WRAPPER
//=============================================================================
// This module provides a synthesis-friendly wrapper for the Ethernet IP,
// with explicit signal ports instead of struct interfaces.
//
// PURPOSE:
//   - Unpacks AXI-Stream and REG_BUS structs into individual signals
//   - Provides a flat port list for synthesis tools
//   - Maintains compatibility with tools that don't support SystemVerilog interfaces
//   - Suitable for FPGA synthesis and simulation
//
// DIFFERENCES FROM eth_top:
//   - eth_top: Uses struct interfaces (axi_stream_req_t, reg_req_t)
//   - eth_top_synth: Uses individual signals (tdata, tvalid, tready, etc.)
//   - Same functionality, different interface style
//
// TYPICAL USAGE:
//   - Use in FPGA synthesis flows
//   - Use when integrating with non-SystemVerilog tools
//   - Use in testbenches that prefer explicit signals
//
// INTERFACE MAPPING:
//   AXI-Stream TX: tx_axis_tdata_i, tx_axis_tvalid_i, tx_axis_tready_o, etc.
//   AXI-Stream RX: rx_axis_tdata_o, rx_axis_tvalid_o, rx_axis_tready_i, etc.
//   REG_BUS: reg_bus_addr_i, reg_bus_wdata_i, reg_bus_rdata_o, etc.
//   RGMII: phy_tx_clk, phy_txd, phy_tx_ctl, etc.
//=============================================================================
